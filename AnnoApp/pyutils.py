...
def write_anno(name, text):
    with open(f'AnnoApp/templates/mlip/{name}.html', 'w') as f:
        ...
        f.write("      background-color: indigo; \n")
        f.write("    }\n")
        f.write("    .button_APPLICATION {\n")
        f.write("      background-color: darkorange; \n")
        f.write("    }\n")
        ...
        f.write("      <button type='button' class='button button_PHENOMENON' onclick='Select_Func(\"PHENOMENON\")'>PHENOMENON</button> \n")
        ...
        f.write("      if  (Class === 'PHENOMENON') F = Func_PHENOMENON\n")
        ...
        f.write("    }\n")
        f.write("    function Func_PHENOMENON(id) {\n")
        f.write("      document.getElementById(id).style.backgroundColor = 'teal';\n")
        f.write("      document.getElementById(id).style.color = 'white';\n")
        f.write("      annotation[id] = 'PHENOMENON';\n")
        f.write("    }\n")
        ...
        f.write("      document.getElementById(id).style.backgroundColor = 'indigo';\n")
        f.write("      document.getElementById(id).style.color = 'white';\n")
        f.write("      annotation[id] = 'VALUE';\n")
        f.write("    }\n")
        f.write("    function Func_APPLICATION(id) {\n")
        f.write("      document.getElementById(id).style.backgroundColor = 'darkorange';\n")
        f.write("      document.getElementById(id).style.color = 'white';\n")
